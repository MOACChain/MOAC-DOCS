...
The ``chain3.mc.accounts`` contains functions to generate Ethereum accounts and sign transactions and data.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.create([entropy]);

Generates an account object with private key and public key. It's different from
:ref:`chain3.mc.personal.newAccount() <personal-newaccount>` which creates an account
...
``Object`` - The account object with the following structure:
    ...
    - ``signTransaction(tx [, callback])`` - ``Function``: The function to sign transactions. See :ref:`chain3.mc.accounts.signTransaction() <mc-accounts-signtransaction>` for more.
    - ``sign(data)`` - ``Function``: The function to sign transactions. See :ref:`chain3.mc.accounts.sign() <mc-accounts-sign>` for more.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.create('2435@#@#@±±±±!!!!678543213456764321§34567543213456785432134567');
    > {
    ...
    chain3.mc.accounts.create(web3.utils.randomHex(32));
    > {
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.privateKeyToAccount(privateKey);
...
``Object`` - The account object with the :ref:`structure seen here <mc-accounts-create-return>`.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.privateKeyToAccount('0x348ce564d427a3311b6536bbcff9390d69395b06ed6c486954e971d960fe8709');
    > {
        address: '0xb8CE9ab6943e0eCED004cDe8e3bBed6568B2Fa01',
        privateKey: '0x348ce564d427a3311b6536bbcff9390d69395b06ed6c486954e971d960fe8709',
        signTransaction: function(tx){...},
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.signTransaction(tx, privateKey [, callback]);
...
1. ``tx`` - ``Object``: The transaction's properties object as follows:
    - ``nonce`` - ``String``: (optional) The nonce to use when signing this transaction. Default will use :ref:`chain3.mc.getTransactionCount() <mc-gettransactioncount>`.
    - ``chainId`` - ``String``: (optional) The chain id to use when signing this transaction. Default will use :ref:`chain3.mc.net.getId() <net-getid>`.
    - ``to`` - ``String``: (optional) The receiver of the transaction, can be empty when deploying a contract.
    - ``data`` - ``String``: (optional) The call data of the transaction, can be empty for simple value transfers.
    - ``value`` - ``String``: (optional) The value of the transaction in wei.
    - ``gasPrice`` - ``String``: (optional) The gas price set by this transaction, if empty, it will use :ref:`chain3.mc.gasPrice() <mc-gasprice>`
...
``Promise`` returning ``Object``: The signed data RLP encoded transaction, or if ``returnSignature`` is ``true`` the signature values as follows:
    ...
    - ``rawTransaction`` - ``String``: The RLP encoded transaction, ready to be send using :ref:`chain3.mc.sendSignedTransaction <mc-sendsignedtransaction>`.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.signTransaction({
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.recoverTransaction(rawTransaction);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.recoverTransaction('0xf86180808401ef364594f0109fc8df283027b6285cc889f5aa624eac1f5580801ca031573280d608f75137e33fc14655f097867d691d5c4c44ebe5ae186070ac3d5ea0524410802cdc025034daefcdfa08e7d2ee3f0b9d9ae184b2001fe0aff07603d9');
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.hashMessage(message);

Hashes the given message to be passed :ref:`chain3.mc.accounts.recover() <accounts-recover>` function. The data  will be UTF-8 HEX decoded and enveloped as follows: ``"\x19Ethereum Signed Message:\n" + message.length + message`` and hashed using keccak256.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.hashMessage("Hello World")
    > "0xa1de988600a42c4b4ab089b619297c17d53cffae5d5120d82d8a92d0bb3b78f2"

    // the below results in the same hash
    chain3.mc.accounts.hashMessage(web3.utils.utf8ToHex("Hello World"))
    > "0xa1de988600a42c4b4ab089b619297c17d53cffae5d5120d82d8a92d0bb3b78f2"
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.sign(data, privateKey);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.sign('Some data', '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318');
    > {
        message: 'Some data',
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.recover(signatureObject);
    chain3.mc.accounts.recover(message, signature [, preFixed]);
    chain3.mc.accounts.recover(message, v, r, s [, preFixed]);
...
.. code-block:: javascript
    ...
    // message, signature
    chain3.mc.accounts.recover('Some data', '0xb91467e570a6466aa9e9876cbcd013baba02900b8979d43fe208a4a4f339f5fd6007e74cd82e037b800186422fc2da167c747ef045e5d18a5f5d4300f8e1a0291c');
    > "0x2c7536E3605D9C16a7a3D7b1898e529396a65c23"

    // message, v, r, s
    chain3.mc.accounts.recover('Some data', '0x1c', '0xb91467e570a6466aa9e9876cbcd013baba02900b8979d43fe208a4a4f339f5fd', '0x6007e74cd82e037b800186422fc2da167c747ef045e5d18a5f5d4300f8e1a029');
    > "0x2c7536E3605D9C16a7a3D7b1898e529396a65c23"
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.encrypt(privateKey, password);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.encrypt('0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318', 'test!')
    > {
        version: 3,
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.decrypt(keystoreJsonV3, password);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet;

Contains an in memory wallet with multiple accounts. These accounts can be used when using :ref:`chain3.mc.sendTransaction() <mc-sendtransaction>`.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.create(numberOfAccounts [, entropy]);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.create(2, '54674321§3456764321§345674321§3453647544±±±§±±±!!!43534534534534');
    > Wallet {
        0: {...},
        "0xF0109fC8DF283027b6285cc889F5aA624EaC1F55": {...},
        "0xf0109fc8df283027b6285cc889f5aa624eac1f55": {...},
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.add(account);
...
1. ``account`` - ``String|Object``: A private key or account object created with :ref:`chain3.mc.accounts.create() <accounts-create>`.
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.add('0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318');
    > {
        index: 0,
        address: '0x2c7536E3605D9C16a7a3D7b1898e529396a65c23',
        privateKey: '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318',
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.remove(account);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.remove('0xF0109fC8DF283027b6285cc889F5aA624EaC1F55');
    > true

    chain3.mc.accounts.wallet.remove(3);
    > false
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.clear();
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.encrypt(password);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.encrypt('test');
    > [ { version: 3,
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.decrypt(keystoreArray, password);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.decrypt([
      { version: 3,
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.save(password [, keyName]);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.save('test#!$');
    > true
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.load(password [, keyName]);
...
.. code-block:: javascript
    ...
    chain3.mc.accounts.wallet.load('test#!$', 'myWalletKey');
    > Wallet {
        0: {...},
        1: {...},
        "0xF0109fC8DF283027b6285cc889F5aA624EaC1F55": {...},
