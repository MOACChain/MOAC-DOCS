...
The ``chain3.mc.Contract`` object makes it easy to interact with smart contracts on the Ethereum blockchain.
...
.. code-block:: javascript
    import {Contract} from 'chain3-mc-contract';
...
.. code-block:: javascript
    ...
    new chain3.mc.Contract(jsonInterface, address, options)
...
.. code-block:: javascript
    ...
    const myContract = new chain3.mc.Contract([...], '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe', {
...
.. code-block:: javascript
    ...
    // web3.js
    const MyContract = new chain3.mc.Contract(abi, address);
